...
function Marquees() {
  ...
  return (
    <div className="w-full mt-72 flex flex-col gap-10 relative overflow-hidden py-20 ">
      {images.map((items , index)=> <Marquee key={index} direction={index === 0 ? "left" : "right"}  imagesUrl={items}/>)}
    </div>
  );
}
